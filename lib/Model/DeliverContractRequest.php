...
class DeliverContractRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'deliver_contract_request';
    ...
    */
     ...
     * Sets ship_symbol
     *
     * @param string $ship_symbol Symbol of a ship located in the destination to deliver a contract and that has a good to deliver in its cargo.
     *
     * @return self
     */
     ...
     * Sets trade_symbol
     *
     * @param string $trade_symbol The symbol of the good to deliver.
     *
     * @return self
     */
