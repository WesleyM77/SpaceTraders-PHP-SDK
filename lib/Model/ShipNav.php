...
class ShipNav implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShipNav';
    ...
    protected static $openAPITypes = [
        ...
        'flight_mode' => '\OpenAPI\Client\Model\ShipNavFlightMode'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('flight_mode', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['flight_mode'] === null) {
            $invalidProperties[] = "'flight_mode' can't be null";
        }
    ...
    public function setSystemSymbol($system_symbol)
    {
        ...
        if ((mb_strlen($system_symbol) < 1)) {
            throw new \InvalidArgumentException('invalid length for $system_symbol when calling ShipNav., must be bigger than or equal to 1.');
        }
    ...
    public function setWaypointSymbol($waypoint_symbol)
    {
        ...
        if ((mb_strlen($waypoint_symbol) < 1)) {
            throw new \InvalidArgumentException('invalid length for $waypoint_symbol when calling ShipNav., must be bigger than or equal to 1.');
        }
    ...
    {
        return $this->container['flight_mode'];
    }

    /**
     * Sets flight_mode
     *
     * @param \OpenAPI\Client\Model\ShipNavFlightMode $flight_mode flight_mode
     *
     * @return self
     */
    public function setFlightMode($flight_mode)
    {
        if (is_null($flight_mode)) {
            throw new \InvalidArgumentException('non-nullable flight_mode cannot be null');
        }
        $this->container['flight_mode'] = $flight_mode;
