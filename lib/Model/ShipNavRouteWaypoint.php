...
class ShipNavRouteWaypoint implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShipNavRouteWaypoint';
    ...
    */
    ...
    public function setSystemSymbol($system_symbol)
    {
        ...
        if ((mb_strlen($system_symbol) < 1)) {
            throw new \InvalidArgumentException('invalid length for $system_symbol when calling ShipNavRouteWaypoint., must be bigger than or equal to 1.');
        }
