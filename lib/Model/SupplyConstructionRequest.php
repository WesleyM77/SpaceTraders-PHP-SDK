...
class SupplyConstructionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'supply_construction_request';
    ...
    */
     ...
     * Sets ship_symbol
     *
     * @param string $ship_symbol Symbol of the ship to use.
     *
     * @return self
     */
     ...
     * Sets trade_symbol
     *
     * @param string $trade_symbol The symbol of the good to supply.
     *
     * @return self
     */
