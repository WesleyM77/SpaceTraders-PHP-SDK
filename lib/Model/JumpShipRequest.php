...
class JumpShipRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'jump_ship_request';
    ...
    */
     ...
     *
     * @param string $waypoint_symbol The symbol of the waypoint to jump to. The destination must be a connected waypoint.
     *
     * @return self
     */
