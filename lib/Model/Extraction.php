...
class Extraction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets ship_symbol
     *
     * @param string $ship_symbol Symbol of the ship that executed the extraction.
     *
     * @return self
     */
    public function setShipSymbol($ship_symbol)
    {
        ...
        if ((mb_strlen($ship_symbol) < 1)) {
            throw new \InvalidArgumentException('invalid length for $ship_symbol when calling Extraction., must be bigger than or equal to 1.');
        }
