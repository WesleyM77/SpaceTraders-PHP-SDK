...
class ShipyardTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShipyardTransaction';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ship_type'] === null) {
            $invalidProperties[] = "'ship_type' can't be null";
        }
    ...
    public function setWaypointSymbol($waypoint_symbol)
    {
        ...
        if ((mb_strlen($waypoint_symbol) < 1)) {
            throw new \InvalidArgumentException('invalid length for $waypoint_symbol when calling ShipyardTransaction., must be bigger than or equal to 1.');
        }
     ...
     * Sets ship_symbol
     *
     * @param string $ship_symbol The symbol of the ship that was the subject of the transaction.
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets ship_type
     *
     * @param string $ship_type The symbol of the ship that was the subject of the transaction.
     *
     * @return self
     */
     ...
     * Sets agent_symbol
     *
     * @param string $agent_symbol The symbol of the agent that made the transaction.
     *
     * @return self
     */
