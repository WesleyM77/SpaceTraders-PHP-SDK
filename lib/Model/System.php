...
class System implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets sector_symbol
     *
     * @param string $sector_symbol The symbol of the sector.
     *
     * @return self
     */
    public function setSectorSymbol($sector_symbol)
    {
        ...
        if ((mb_strlen($sector_symbol) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sector_symbol when calling System., must be bigger than or equal to 1.');
        }
