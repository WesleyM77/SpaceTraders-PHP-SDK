...
class ShipModificationTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShipModificationTransaction';
    ...
    */
     ...
     *
     * @param string $waypoint_symbol The symbol of the waypoint where the transaction took place.
     *
     * @return self
     */
    ...
    public function setTotalPrice($total_price)
    {
        ...
        if (($total_price < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_price when calling ShipModificationTransaction., must be bigger than or equal to 0.');
        }
