...
class Siphon implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Siphon';
    ...
    */
     ...
     * Sets ship_symbol
     *
     * @param string $ship_symbol Symbol of the ship that executed the siphon.
     *
     * @return self
     */
    public function setShipSymbol($ship_symbol)
    {
        ...
        if ((mb_strlen($ship_symbol) < 1)) {
            throw new \InvalidArgumentException('invalid length for $ship_symbol when calling Siphon., must be bigger than or equal to 1.');
        }
