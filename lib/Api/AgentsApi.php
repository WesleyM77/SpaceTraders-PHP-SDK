...
class AgentsApi
{
     ...
     * Get Public Agent
     *
     * @param  string $agent_symbol The agent symbol (required)
     ...
     */
    public function getAgent($agent_symbol, string $contentType = self::contentTypes['getAgent'][0])
    {
        list($response) = $this->getAgentWithHttpInfo($agent_symbol, $contentType);
        return $response;
    }
     ...
     */
    public function getAgentWithHttpInfo($agent_symbol, string $contentType = self::contentTypes['getAgent'][0])
    {
        $request = $this->getAgentRequest($agent_symbol, $contentType);
     ...
     */
    public function getAgentAsync($agent_symbol, string $contentType = self::contentTypes['getAgent'][0])
    {
        return $this->getAgentAsyncWithHttpInfo($agent_symbol, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAgentAsyncWithHttpInfo($agent_symbol, string $contentType = self::contentTypes['getAgent'][0])
    {
        $returnType = '\OpenAPI\Client\Model\GetMyAgent200Response';
        $request = $this->getAgentRequest($agent_symbol, $contentType);
     ...
     */
    public function getAgentRequest($agent_symbol, string $contentType = self::contentTypes['getAgent'][0])
    {

        // verify the required parameter 'agent_symbol' is set
        if ($agent_symbol === null || (is_array($agent_symbol) && count($agent_symbol) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $agent_symbol when calling getAgent'
            );
        }
        ...
        // path params
        if ($agent_symbol !== null) {
            $resourcePath = str_replace(
                '{' . 'agentSymbol' . '}',
                ObjectSerializer::toPathValue($agent_symbol),
                $resourcePath
            );
        }
     ...
     */
    public function getAgents($page = 1, $limit = 10, string $contentType = self::contentTypes['getAgents'][0])
    {
     ...
     */
    public function getAgentsWithHttpInfo($page = 1, $limit = 10, string $contentType = self::contentTypes['getAgents'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAgentsAsync($page = 1, $limit = 10, string $contentType = self::contentTypes['getAgents'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAgentsAsyncWithHttpInfo($page = 1, $limit = 10, string $contentType = self::contentTypes['getAgents'][0])
    {
        $returnType = '\OpenAPI\Client\Model\GetAgents200Response';
        $request = $this->getAgentsRequest($page, $limit, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAgentsRequest($page = 1, $limit = 10, string $contentType = self::contentTypes['getAgents'][0])
    {
     ...
     * @return \OpenAPI\Client\Model\GetMyAgent200Response
     */
    public function getMyAgent(string $contentType = self::contentTypes['getMyAgent'][0])
    {
     ...
     * @return array of \OpenAPI\Client\Model\GetMyAgent200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMyAgentWithHttpInfo(string $contentType = self::contentTypes['getMyAgent'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMyAgentAsync(string $contentType = self::contentTypes['getMyAgent'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMyAgentAsyncWithHttpInfo(string $contentType = self::contentTypes['getMyAgent'][0])
    {
        $returnType = '\OpenAPI\Client\Model\GetMyAgent200Response';
        $request = $this->getMyAgentRequest($contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getMyAgentRequest(string $contentType = self::contentTypes['getMyAgent'][0])
    {
